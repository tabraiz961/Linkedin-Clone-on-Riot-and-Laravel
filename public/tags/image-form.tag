<image-form>
    ...
    <form ref="form" class="form-container" onreset={ cancel } onsubmit={ submit }>
        <div>
            <img id="imgPreview"
                src="data:image/svg+xml;charset=utf8,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%3E%3C/svg%3E" alt="pic" />
            <textarea ref="text_content" name="description" class="text-content"></textarea>
            <div class="toolbar">
                <input id="photo" ref="file" if={ !edit } type="file" name="image" required accept="image/jpeg,image/png"
