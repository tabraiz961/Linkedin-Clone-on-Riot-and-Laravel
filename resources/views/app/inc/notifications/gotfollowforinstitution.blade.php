	...
	<div class="grid-x">
		...
		<div class="cell medium-9 notification_details">
			<div class="noti_det_child">
				<a href="{{route('user.profile', $notification['data']['sender']['username'])}}"><b>{{ $notification['data']['sender']['curated_name'] }}</b> {{ trans('lang.followed_page') .' '}} <b>{{ $notification['data']['receiver']['institution']['institution_name']}}</b> </a>
