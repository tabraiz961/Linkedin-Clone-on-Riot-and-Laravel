...
<script data-src="{{ asset( 'tags/tag-newprofiles.tag' ) }}" type="riot/tag"></script>
<script data-src="{{ asset( 'tags/tag-institutions.tag' ) }}" type="riot/tag"></script>
<script data-src="{{ asset( 'tags/tag-profilepeople.tag' ) }}" type="riot/tag"></script> 
...
<script data-src="{{ asset( 'tags/card-loaders.tag' ) }}" type="riot/tag"></script>
...
<script data-src="{{ asset( 'tags/profile-skills.tag' ) }}" type="riot/tag"></script>
