			...
			<div class="card-section">
				<div class="grid-x grid-margin-x">
					...
					<div class="cell auto">
						...
						<p class="date">Published <span class="content">{{ $job->created_at }}</span></p>
						@if( !$job->author->isSame( Auth::user() ) )
							<a class="button" data-open="applicationForm">To apply</a>
						@endif
					</div>
				</div>
	...
	@if( !$job->author->isSame( Auth::user() ) )
		<div class="reveal" id="applicationForm" data-reveal>
			...
			<div class="content">
				...
				<div>
					{{ Form::label('coverLetter', 'Cover letter', ['class' => ($errors->has('coverLetter') ? 'is-invalid-label' : '')]) }}
