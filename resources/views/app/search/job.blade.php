...
@section('content')
	@if( env( 'ALGOLIA_APP_ID', '' ) === '' )
		<div class="callout alert">
			Search is not configured in the application.
		</div>
	@else
				...
				<div class="cell small-12 medium-8 large-9">
					<div class="callout card search-panel">
						<div class="card-divider">
							<ul class="menu">
								<li><a href="{{ route( 'search.user', [ 'q' => $query ] ) }}">Users</a></li>
								<li class="is-active"><a>Job offers</a></li>
							</ul>
		...
		<script>
			...
			search.addWidget(
				window.instantsearch_widgets.hits( {
					container: '#hits',
					templates: {
						empty: '<p class="text-center">No result.</p>',
