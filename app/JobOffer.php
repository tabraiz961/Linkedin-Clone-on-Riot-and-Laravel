...
class JobOffer extends Model {
	...
	public function skills() {
		return $this->hasMany(JobSkills::class, 'job_id', 'job_id');
	}
	public function languages() {
		return $this->hasMany(JobLanguagesRequired::class, 'job_id', 'job_id');
	}
	public function appliedUsers() {
		return $this->hasMany(JobApplied::class, 'job_id', 'job_id');
	}
